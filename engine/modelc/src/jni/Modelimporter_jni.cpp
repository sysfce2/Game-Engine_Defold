...
void InitializeJNITypes(JNIEnv* env, TypeInfos* infos) {
    ...
    {
        SETUP_CLASS(Vec3fJNI, "Vec3f");
        GET_FLD_TYPESTR(x, "F");
        GET_FLD_TYPESTR(y, "F");
        GET_FLD_TYPESTR(z, "F");
    }
    {
        SETUP_CLASS(Vec4fJNI, "Vec4f");
        GET_FLD_TYPESTR(x, "F");
        GET_FLD_TYPESTR(y, "F");
        GET_FLD_TYPESTR(z, "F");
        GET_FLD_TYPESTR(w, "F");
    ...
    }
    {
        ...
        GET_FLD(translation, "Vec3f");
        GET_FLD(scale, "Vec3f");
        GET_FLD(rotation, "Vec4f");
    }
    {
...
void FinalizeJNITypes(JNIEnv* env, TypeInfos* infos) {
    env->DeleteLocalRef(infos->m_Vec3fJNI.cls);
    env->DeleteLocalRef(infos->m_Vec4fJNI.cls);
...
jobject C2J_CreateVec3f(JNIEnv* env, TypeInfos* types, const Vec3f* src) {
    if (src == 0) return 0;
    jobject obj = env->AllocObject(types->m_Vec3fJNI.cls);
    dmJNI::SetFloat(env, obj, types->m_Vec3fJNI.x, src->x);
    dmJNI::SetFloat(env, obj, types->m_Vec3fJNI.y, src->y);
    dmJNI::SetFloat(env, obj, types->m_Vec3fJNI.z, src->z);
    return obj;
}

jobject C2J_CreateVec4f(JNIEnv* env, TypeInfos* types, const Vec4f* src) {
    if (src == 0) return 0;
    jobject obj = env->AllocObject(types->m_Vec4fJNI.cls);
    dmJNI::SetFloat(env, obj, types->m_Vec4fJNI.x, src->x);
    dmJNI::SetFloat(env, obj, types->m_Vec4fJNI.y, src->y);
    dmJNI::SetFloat(env, obj, types->m_Vec4fJNI.z, src->z);
    dmJNI::SetFloat(env, obj, types->m_Vec4fJNI.w, src->w);
    return obj;
}
...
jobject C2J_CreateAabb(JNIEnv* env, TypeInfos* types, const Aabb* src) {
    ...
    dmJNI::SetObjectDeref(env, obj, types->m_AabbJNI.min, C2J_CreateVec3f(env, types, &src->m_Min));
    dmJNI::SetObjectDeref(env, obj, types->m_AabbJNI.max, C2J_CreateVec3f(env, types, &src->m_Max));
    return obj;
}
...
jobject C2J_CreateTransform(JNIEnv* env, TypeInfos* types, const Transform* src) {
    ...
    dmJNI::SetObjectDeref(env, obj, types->m_TransformJNI.translation, C2J_CreateVec3f(env, types, &src->m_Translation));
    dmJNI::SetObjectDeref(env, obj, types->m_TransformJNI.scale, C2J_CreateVec3f(env, types, &src->m_Scale));
    dmJNI::SetObjectDeref(env, obj, types->m_TransformJNI.rotation, C2J_CreateVec4f(env, types, &src->m_Rotation));
    return obj;
}
...
jobject C2J_CreateMaterial(JNIEnv* env, TypeInfos* types, const Material* src) {
    ...
    dmJNI::SetInt(env, obj, types->m_MaterialJNI.index, src->m_Index);
    dmJNI::SetByte(env, obj, types->m_MaterialJNI.isSkinned, src->m_IsSkinned);
    return obj;
}
...
jobject C2J_CreateMesh(JNIEnv* env, TypeInfos* types, const Mesh* src) {
    ...
    dmJNI::SetInt(env, obj, types->m_MeshJNI.vertexCount, src->m_VertexCount);
...
jobject C2J_CreateModel(JNIEnv* env, TypeInfos* types, const Model* src) {
    ...
    dmJNI::SetInt(env, obj, types->m_ModelJNI.index, src->m_Index);
...
jobject C2J_CreateBone(JNIEnv* env, TypeInfos* types, const Bone* src) {
    ...
    dmJNI::SetInt(env, obj, types->m_BoneJNI.index, src->m_Index);
...
jobject C2J_CreateSkin(JNIEnv* env, TypeInfos* types, const Skin* src) {
    ...
    dmJNI::SetObjectDeref(env, obj, types->m_SkinJNI.bones, C2J_CreateBonePtrArray(env, types, src->m_Bones.Begin(), src->m_Bones.Size()));
    dmJNI::SetObjectDeref(env, obj, types->m_SkinJNI.boneRemap, dmJNI::C2J_CreateIntArray(env, src->m_BoneRemap.Begin(), src->m_BoneRemap.Size()));
    return obj;
}
...
jobject C2J_CreateNode(JNIEnv* env, TypeInfos* types, const Node* src) {
    ...
    dmJNI::SetInt(env, obj, types->m_NodeJNI.index, src->m_Index);
    dmJNI::SetLong(env, obj, types->m_NodeJNI.nameHash, src->m_NameHash);
    return obj;
}
...
jobject C2J_CreateBuffer(JNIEnv* env, TypeInfos* types, const Buffer* src) {
    ...
    dmJNI::SetInt(env, obj, types->m_BufferJNI.bufferSize, src->m_BufferSize);
    return obj;
}
...
jobjectArray C2J_CreateVec3fArray(JNIEnv* env, TypeInfos* types, const Vec3f* src, uint32_t src_count) {
    ...
    jobjectArray arr = env->NewObjectArray(src_count, types->m_Vec3fJNI.cls, 0);
    for (uint32_t i = 0; i < src_count; ++i) {
        jobject obj = C2J_CreateVec3f(env, types, &src[i]);
...
jobjectArray C2J_CreateVec4fArray(JNIEnv* env, TypeInfos* types, const Vec4f* src, uint32_t src_count) {
    if (src == 0 || src_count == 0) return 0;
    jobjectArray arr = env->NewObjectArray(src_count, types->m_Vec4fJNI.cls, 0);
    for (uint32_t i = 0; i < src_count; ++i) {
        jobject obj = C2J_CreateVec4f(env, types, &src[i]);
        env->SetObjectArrayElement(arr, i, obj);
        env->DeleteLocalRef(obj);
    }
    return arr;
...
bool J2C_CreateVec3f(JNIEnv* env, TypeInfos* types, jobject obj, Vec3f* out) {
    ...
    out->x = dmJNI::GetFloat(env, obj, types->m_Vec3fJNI.x);
    out->y = dmJNI::GetFloat(env, obj, types->m_Vec3fJNI.y);
    out->z = dmJNI::GetFloat(env, obj, types->m_Vec3fJNI.z);
    return true;
}

bool J2C_CreateVec4f(JNIEnv* env, TypeInfos* types, jobject obj, Vec4f* out) {
    if (out == 0) return false;
    out->x = dmJNI::GetFloat(env, obj, types->m_Vec4fJNI.x);
    out->y = dmJNI::GetFloat(env, obj, types->m_Vec4fJNI.y);
    out->z = dmJNI::GetFloat(env, obj, types->m_Vec4fJNI.z);
    out->w = dmJNI::GetFloat(env, obj, types->m_Vec4fJNI.w);
    return true;
}
...
bool J2C_CreateAabb(JNIEnv* env, TypeInfos* types, jobject obj, Aabb* out) {
    if (out == 0) return false;
    {
        ...
        if (field_object) {
            J2C_CreateVec3f(env, types, field_object, &out->m_Min);
    ...
    }
    {
        ...
        if (field_object) {
            J2C_CreateVec3f(env, types, field_object, &out->m_Max);
            env->DeleteLocalRef(field_object);
        }
    }
    return true;
...
bool J2C_CreateTransform(JNIEnv* env, TypeInfos* types, jobject obj, Transform* out) {
    if (out == 0) return false;
    {
        ...
        if (field_object) {
            J2C_CreateVec3f(env, types, field_object, &out->m_Translation);
            env->DeleteLocalRef(field_object);
        }
    }
    {
        ...
        if (field_object) {
            J2C_CreateVec3f(env, types, field_object, &out->m_Scale);
            env->DeleteLocalRef(field_object);
        }
    }
    {
        ...
        if (field_object) {
            J2C_CreateVec4f(env, types, field_object, &out->m_Rotation);
            env->DeleteLocalRef(field_object);
        }
    }
    return true;
...
bool J2C_CreateMaterial(JNIEnv* env, TypeInfos* types, jobject obj, Material* out) {
    ...
    out->m_Index = dmJNI::GetInt(env, obj, types->m_MaterialJNI.index);
    out->m_IsSkinned = dmJNI::GetByte(env, obj, types->m_MaterialJNI.isSkinned);
    return true;
}
...
bool J2C_CreateMesh(JNIEnv* env, TypeInfos* types, jobject obj, Mesh* out) {
    ...
    out->m_VertexCount = dmJNI::GetInt(env, obj, types->m_MeshJNI.vertexCount);
    {
    ...
    out->m_TexCoords1NumComponents = dmJNI::GetInt(env, obj, types->m_MeshJNI.texCoords1NumComponents);
    {
        ...
        if (field_object) {
            uint32_t tmp_count;
            int32_t* tmp = dmJNI::J2C_CreateIntArray(env, (jintArray)field_object, &tmp_count);
...
bool J2C_CreateModel(JNIEnv* env, TypeInfos* types, jobject obj, Model* out) {
    ...
    out->m_Index = dmJNI::GetInt(env, obj, types->m_ModelJNI.index);
    {
...
bool J2C_CreateBone(JNIEnv* env, TypeInfos* types, jobject obj, Bone* out) {
    ...
    out->m_Index = dmJNI::GetInt(env, obj, types->m_BoneJNI.index);
    {
...
bool J2C_CreateSkin(JNIEnv* env, TypeInfos* types, jobject obj, Skin* out) {
    ...
    out->m_Index = dmJNI::GetInt(env, obj, types->m_SkinJNI.index);
    {
...
bool J2C_CreateNode(JNIEnv* env, TypeInfos* types, jobject obj, Node* out) {
    ...
    out->m_Index = dmJNI::GetInt(env, obj, types->m_NodeJNI.index);
    out->m_NameHash = dmJNI::GetLong(env, obj, types->m_NodeJNI.nameHash);
    return true;
}
...
bool J2C_CreateBuffer(JNIEnv* env, TypeInfos* types, jobject obj, Buffer* out) {
    ...
    out->m_BufferSize = dmJNI::GetInt(env, obj, types->m_BufferJNI.bufferSize);
    return true;
}
...
void J2C_CreateVec3fArrayInPlace(JNIEnv* env, TypeInfos* types, jobjectArray arr, Vec3f* dst, uint32_t dst_count) {
    ...
    for (uint32_t i = 0; i < len; ++i) {
        ...
        J2C_CreateVec3f(env, types, obj, &dst[i]);
        env->DeleteLocalRef(obj);
    }
}
Vec3f* J2C_CreateVec3fArray(JNIEnv* env, TypeInfos* types, jobjectArray arr, uint32_t* out_count) {
    jsize len = env->GetArrayLength(arr);
    Vec3f* out = new Vec3f[len];
    J2C_CreateVec3fArrayInPlace(env, types, arr, out, len);
...
Vec3f** J2C_CreateVec3fPtrArray(JNIEnv* env, TypeInfos* types, jobjectArray arr, uint32_t* out_count) {
    jsize len = env->GetArrayLength(arr);
    Vec3f** out = new Vec3f*[len];
    J2C_CreateVec3fPtrArrayInPlace(env, types, arr, out, len);
    *out_count = (uint32_t)len;
    return out;
}
void J2C_CreateVec4fArrayInPlace(JNIEnv* env, TypeInfos* types, jobjectArray arr, Vec4f* dst, uint32_t dst_count) {
    ...
    for (uint32_t i = 0; i < len; ++i) {
        jobject obj = env->GetObjectArrayElement(arr, i);
        J2C_CreateVec4f(env, types, obj, &dst[i]);
        env->DeleteLocalRef(obj);
    }
}
Vec4f* J2C_CreateVec4fArray(JNIEnv* env, TypeInfos* types, jobjectArray arr, uint32_t* out_count) {
    jsize len = env->GetArrayLength(arr);
    Vec4f* out = new Vec4f[len];
    J2C_CreateVec4fArrayInPlace(env, types, arr, out, len);
    *out_count = (uint32_t)len;
    return out;
}
...
Vec4f** J2C_CreateVec4fPtrArray(JNIEnv* env, TypeInfos* types, jobjectArray arr, uint32_t* out_count) {
    jsize len = env->GetArrayLength(arr);
    Vec4f** out = new Vec4f*[len];
    J2C_CreateVec4fPtrArrayInPlace(env, types, arr, out, len);
    *out_count = (uint32_t)len;
    return out;
}
